# -*- coding: utf-8 -*-
"""
生成中文美国出发城市页 zh-cn/usa-to-china/{city}/
与英文城市页对称，hreflang 互链。
"""
...
CITIES = [
    {"slug": "los-angeles", "zh": "洛杉矶", "en": "Los Angeles", "note": "美西最大华人聚集地，直飞中国航线最多，取件最快"},
    {"slug": "new-york", "zh": "纽约", "en": "New York", "note": "美东华人中心，留学生与代购群体最密集"},
    {"slug": "san-francisco", "zh": "旧金山", "en": "San Francisco", "note": "硅谷华人圈，科技从业者与海归寄件高频"},
    {"slug": "chicago", "zh": "芝加哥", "en": "Chicago", "note": "美中物流枢纽，辐射中西部各州"},
    {"slug": "houston", "zh": "休斯顿", "en": "Houston", "note": "能源之都，华人社区成熟，大件搬家需求多"},
    {"slug": "boston", "zh": "波士顿", "en": "Boston", "note": "大学城，留学生行李寄回国需求最集中"},
    {"slug": "seattle", "zh": "西雅图", "en": "Seattle", "note": "科技公司华人多，亚马逊/微软员工寄件高频"},
...
@media(max-width:768px){.nav{display:none;position:absolute;top:var(--nav-height);left:0;right:0;background:#fff;flex-direction:column;padding:16px 24px;box-shadow:0 8px 32px rgba(0,0,0,.1);gap:4px}.nav.open{display:flex}.burger{display:block}.nav a{width:100%;padding:10px 16px}}
...
.info-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:16px;margin-bottom:36px}
.info-card{background:#fff;border-radius:var(--radius-lg);padding:26px;text-align:center;border:1px solid var(--border)}
.info-card .big{font-size:1.7rem;font-weight:800;color:var(--primary);margin-bottom:4px}
...
.process{display:flex;justify-content:center;gap:20px;flex-wrap:wrap}
.step{text-align:center;width:200px}
.step-num{width:44px;height:44px;border-radius:50%;background:var(--primary);color:#fff;display:flex;align-items:center;justify-content:center;font-size:18px;font-weight:700;margin:0 auto 10px}
...
.footer-bottom{text-align:center;padding-top:28px;margin-top:28px;border-top:1px solid rgba(255,255,255,.1);font-size:12px;color:#666}
"""


def nav_html(active_city: str, lang_en: str) -> str:
    ...
    <div class="container">
      ...
      <nav class="nav">
        <a href="/zh-cn/">首页</a>
        <a href="/zh-cn/usa-to-china/" class="active">美国寄中国</a>
        <a href="/zh-cn/student-luggage/">留学生行李</a>
        <a href="/zh-cn/pricing.html">运费报价</a>
        <a href="/zh-cn/tools/">免费工具</a>
        <a href="/zh-cn/blog/">攻略</a>
        <a href="/zh-cn/contact.html">联系我们</a>
        <a href="{lang_en}" class="lang-switch" hreflang="en"><span class="globe">🌐</span><span class="lang-cn">中文</span><span class="sep">/</span><span>English</span></a>
...
def footer_html() -> str:
    ...
    <div class="footer-grid">
      <div><h4>回国线路</h4>
        <a href="/zh-cn/usa-to-china/">美国→中国</a><a href="/zh-cn/japan-to-china/">日本→中国</a>
        <a href="/zh-cn/korea-to-china/">韩国→中国</a><a href="/zh-cn/europe-to-china/">欧洲→中国</a></div>
      <div><h4>寄件指南</h4>
        <a href="/zh-cn/pricing.html">运费报价</a><a href="/zh-cn/tools/">免费工具</a>
        <a href="/zh-cn/faq.html">常见问题</a><a href="/zh-cn/blog/">攻略中心</a></div>
      <div><h4>关于我们</h4>
        <a href="/zh-cn/about.html">公司介绍</a><a href="/zh-cn/contact.html">联系我们</a></div>
      <div><h4>联系方式</h4>
        <p>客服：<a href="https://d.salesmartly.com/fuxikn" target="_blank" rel="noopener">在线咨询</a></p>
        <p>邮箱：<a href="mailto:info@subaog.com">info@subaog.com</a></p></div>
    </div>
    <div class="footer-bottom">© 2026 速豹回国物流 | <a href="/sitemap.xml" style="color:#999">Sitemap</a></div>
  </footer>"""
...
def gen(city: dict):
    ...
    en = city["en"]
    note = city["note"]
    rel = f"usa-to-china/{slug}/index.html"
    zh_url = f"{DOMAIN}/zh-cn/usa-to-china/{slug}/"
    en_url = f"{DOMAIN}/en/usa-to-china/{slug}/"

    title = f"从{zh}寄中国回国行李 | 双清包税门到门 | 速豹回国物流"
    desc = f"从{zh}寄中国专线：双清包税门到门，10-15工作日。{note}。全美免费上门取件，比FedEx/UPS便宜40-60%，全程追踪。"

    faq = [
        (f"从{zh}寄中国多少钱？",
         f"空运21kg+ ¥80/kg起、100kg+ ¥75/kg；海运 ¥45/kg。均为双清包税门到门一口价，含上门取件+空运/海运+中国清关+国内派送。"),
        (f"从{zh}寄中国要多久？",
         f"空运10-15工作日门到门。{zh}华人取件点密布，最快当天上门取件。海运25-35天。"),
        (f"{zh}能免费上门取件吗？",
         f"可以。{zh}全城免费上门取件，{note}，我们预约时间上门收取，无需自送网点。"),
        (f"从{zh}寄什么最划算？",
         "留学生行李、搬家回国、代购发货。21kg以上走空运专线单价最优，大件家具走海运更省。"),
    ]
    ...
    bc_schema = json.dumps({
        ...
        "itemListElement": [
            {"@type": "ListItem", "position": 1, "name": "首页", "item": f"{DOMAIN}/zh-cn/"},
            {"@type": "ListItem", "position": 2, "name": "美国寄中国", "item": f"{DOMAIN}/zh-cn/usa-to-china/"},
            {"@type": "ListItem", "position": 3, "name": f"从{zh}寄中国", "item": zh_url},
        ]
    }, ensure_ascii=False)

    body = f"""  <section class="route-hero">
    <div class="container">
      <h1>从{zh}寄中国 — 双清包税·门到门·10-15工作日</h1>
      <p class="subtitle">{note}。留学生行李、搬家回国、代购发货一站式搞定，比FedEx/UPS便宜40-60%，一口价无隐藏费用。</p>
      <div class="hero-cta">
        <a href="/zh-cn/contact.html" class="btn-primary">📦 获取{zh}寄中国报价</a>
        <a href="/zh-cn/usa-to-china/" class="btn-outline">全部美国线路 →</a>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      <div class="info-grid">
        <div class="info-card"><div class="big">¥80</div><div class="label">/kg 起（21kg+空运）</div></div>
        <div class="info-card"><div class="big">10-15天</div><div class="label">门到门时效</div></div>
        <div class="info-card"><div class="big">双清包税</div><div class="label">一口价含关税</div></div>
        <div class="info-card"><div class="big">免费取件</div><div class="label">{zh}全城上门</div></div>
      </div>

      <div class="section-title"><h2>{zh}寄中国 运费价格表</h2></div>
      <table class="price-table">
        <thead><tr><th>重量段</th><th>空运专线</th><th>海运专线</th><th>时效</th></tr></thead>
        <tbody>
          <tr><td style="font-weight:600">1 - 20 kg</td><td>¥80 /kg</td><td>—</td><td>空运 10-15天</td></tr>
          <tr><td style="font-weight:600">21 - 99 kg</td><td style="color:var(--primary);font-weight:700">¥70 /kg</td><td>¥45 /kg</td><td>空运 10-15天 / 海运 25-35天</td></tr>
          <tr><td style="font-weight:600">100 kg 以上</td><td style="color:var(--primary);font-weight:700">¥75 /kg</td><td>¥45 /kg</td><td>空运 10-15天 / 海运 25-35天</td></tr>
        </tbody>
      </table>
      <p class="note">* 双清包税门到门一口价，含上门取件+干线+中国清关+国内派送。</p>

      <div class="section-title" style="margin-top:44px"><h2>寄送流程</h2></div>
      <div class="process">
        <div class="step"><div class="step-num">1</div><h4>免费咨询</h4><p>告知物品清单+目的地</p></div>
        <div class="step"><div class="step-num">2</div><h4>上门取件</h4><p>{zh}免费上门取件</p></div>
        <div class="step"><div class="step-num">3</div><h4>国际运输</h4><p>空运/海运全程追踪</p></div>
        <div class="step"><div class="step-num">4</div><h4>双清+派送</h4><p>中国清关+直送到门</p></div>
      </div>
    </div>
  </section>
  ...
  <section class="section" style="background:#fff">
    <div class="container">
      <div class="section-title"><h2>从{zh}寄中国 常见问题</h2></div>
      <div class="faq-list">
  ...
  <section class="cta-section"><div class="container"><h2>从{zh}寄回国，先拿个报价</h2><p>告诉我们物品和目的地，30分钟内出方案。</p><a href="/zh-cn/contact.html" class="btn-primary">免费获取报价</a></div></section>"""
...
def main():
    for c in CITIES:
        gen(c)
    print(f"✅ 生成 {len(CITIES)} 个中文美国城市页")
